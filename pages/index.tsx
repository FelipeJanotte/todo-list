          ...
          {todos.map((item, index) => (
            <div key={item.id} className="flex justify-center">
                ...
                <div className="absolute flex top-0 right-0 p-3 space-x-1">
                  <span
                    ...
                    onClick={() => {
                      ...
                      setDescription("");
                      setDescriptionOld(item.description);
              ...
              <div
                ...
                className="modal h-screen w-screen fixed items-center justify-center top-0 bg-black bg-opacity-60 p-16"
              >
                <div className="bg-gray-50 opacity-100 max-w-xl mx-auto p-4 sm:p-6 lg:p-8 rounded-2xl">
                  <h2 className="text-xl font-medium tracking-tight text-gray-900 sm:text-2xl">
                    ...
                    <span className="block text-green-600">{descriptionOld}</span>
